...
},{"dom7/dist/dom7.modular":"../node_modules/dom7/dist/dom7.modular.js","ssr-window":"../node_modules/ssr-window/dist/ssr-window.esm.js"}],"../node_modules/process/browser.js":[function(require,module,exports) {
...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../node_modules/swiper/swiper.scss":[function(require,module,exports) {
...
new _swiper.default(".first-slider.active", {
  slidesPerView: 2,
  autoHeight: true,
  spaceBetween: 20,
  loop: true,
...
(0, _jquery.default)(".js-project-button").click(function (event) {
  // удаляем .active во всех кнопках:
  (0, _jquery.default)(".js-project-button").removeClass("active"); // добавляем .active нажатой кнопке:

  (0, _jquery.default)(event.target).addClass("active"); // // ========== находим индекс кнопки:

  var index = event.target.dataset.index; // // удаляем .active во всех секциях:

  (0, _jquery.default)(".projects-info").removeClass("active"); // //добавляем .active соответствующей секции по индексу:

  (0, _jquery.default)(".projects-info[data-index=" + index + "]").first().addClass("active");
  (0, _jquery.default)(".first-slider").removeClass("active");
  (0, _jquery.default)(".first-slider[data-index=" + index + "]").first().addClass("active");
  new _swiper.default(".first-slider.active", {
    slidesPerView: 2,
    autoHeight: true,
    spaceBetween: 20,
...
(0, _jquery.default)(".js-style-button").click(function (event) {
  // удаляем .active во всех кнопках:
  (0, _jquery.default)(".js-style-button").removeClass("active"); // добавляем .active нажатой кнопке:

  (0, _jquery.default)(event.target).addClass("active"); // // ========== находим индекс кнопки:

  var index = event.target.dataset.index; // // удаляем .active во всех секциях:

  (0, _jquery.default)(".tabs-images").removeClass("active"); // //добавляем .active соответствующей секции по индексу:

  (0, _jquery.default)(".tabs-images[data-index=" + index + "]").first().addClass("active");
}); // ********button for steps-of-repair ********

(0, _jquery.default)(".js-step-button").click(function (event) {
  (0, _jquery.default)(".js-step-button").removeClass("active");
  (0, _jquery.default)(event.target).addClass("active");
  var index = event.target.dataset.index;
  (0, _jquery.default)(".step-content-body").removeClass("active");
  (0, _jquery.default)(".step-content-body[data-index=" + index + "]").first().addClass("active");
  (0, _jquery.default)(".step-image").removeClass("active");
  (0, _jquery.default)(".step-image[data-index=" + index + "]").first().addClass("active");
}); // ********slider for width <=760 ********

var stylesSlider;

var addStylesSlider = function addStylesSlider() {
  var width = window.innerWidth; // Init slider when user on mobile

  if (width <= 760 && !stylesSlider) {
    document.querySelector(".styles-slider").classList.add("swiper-container");
    document.querySelector(".styles-slider-wrapper").classList.add("swiper-wrapper");
    document.querySelectorAll(".tabs-images").forEach(function (item) {
      item.classList.add("swiper-slide");
    });
    stylesSlider = new _swiper.default(".styles-slider", {
      autoHeight: true,
      loop: true
    });
  ...
  if (width > 760 && stylesSlider) {
    ...
    document.querySelector(".styles-slider").classList.remove("swiper-container");
    document.querySelector(".styles-slider-wrapper").classList.remove("swiper-wrapper");
    document.querySelectorAll(".tabs-images").forEach(function (item) {
...
addStylesSlider(); // ******** modal-request ********

document.querySelectorAll(".js-modal-btn").forEach(function (btn, i) {
...
document.querySelector(".modal-request").addEventListener("click", function (event) {
  var isClickInside = document.querySelector(".modal-request-content").contains(event.target);

  if (!isClickInside) {
    document.querySelector(".modal-request").classList.remove("js-show");
  }
});
},{"swiper":"../node_modules/swiper/js/swiper.esm.bundle.js","jquery":"../node_modules/jquery/dist/jquery.js","swiper/swiper.scss":"../node_modules/swiper/swiper.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
